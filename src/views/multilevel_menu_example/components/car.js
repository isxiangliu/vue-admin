...
import { Scene, PerspectiveCamera, WebGLRenderer, AxesHelper, BoxGeometry, MeshBasicMaterial, Mesh, TextureLoader, GridHelper, AmbientLight, PlaneGeometry, MeshPhysicalMaterial, DoubleSide, SpotLight, CylinderGeometry } from 'three';
import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls'
import { GLTFLoader } from 'three/examples/jsm/loaders/GLTFLoader'
// import Lamborghini from '../public/seraphine/Lamborghini.glb'
...
export function initCar() {
    ...
    function loadCarModel() {
        new GLTFLoader().load('seraphine/Lamborghini.glb', (gltf) => {
